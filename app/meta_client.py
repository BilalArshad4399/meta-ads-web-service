...
class MetaAdsClient:
    ...
    def get_account_overview(self, account_id: str, date_range: Dict) -> Dict:
        """Get comprehensive account overview with all metrics"""
        fields = 'account_name,currency,spend,impressions,clicks,conversions,conversion_values,ctr,cpm,cpp,cpc,reach,frequency'
        params = {
            'fields': fields,
